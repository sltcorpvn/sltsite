...
<head>
	...
	<link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>">
        <link rel="icon" href="<?php echo TEMPLATEPATH;?>/alchem-pro/images/favico.ico" type="image/x-icon"/>
        <link rel="shortcut icon" href="<?php echo TEMPLATEPATH;?>/alchem-pro/images/favico.ico" type="image/x-icon"/>
	<!--[if lt IE 9]>
